    ...
    <div className="bg-[#EDF6F4] px-5 lg:px-20 pt-10">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-10 lg:gap-20">
        <div className="w-full lg:w-[40%] text-center lg:text-left">
          <h3 className="text-2xl lg:text-5xl font-bold leading-[35px] lg:leading-[75px]">Find Affordable Rides Anytime, Anywhere,</h3>
        ...
        <div className="image w-full lg:w-[60%]">
          <img src={img17} alt="a driver smiling" className="w-full h-auto object-cover" />
        </div>
      </div>
    </div>
  )
