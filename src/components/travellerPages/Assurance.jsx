    ...
    <div className="w-full px-5 lg:px-20 py-10">
      <div className='flex items-start gap-5 rounded-lg max-w-7xl mx-auto'>
        ...
        <div className="relative hidden lg:block">
          <img src={img15} alt="Main assurance background" className="w-full h-full object-cover" />
          <img src={img16} alt="Secondary overlay" className="absolute top-[43.7vh] left-1/2 transform -translate-x-1/2 -translate-y-1/2" />
          <img src={icon9} alt="Overlay icon" className="absolute top-[50vh] left-1/2 transform -translate-x-1/2 -translate-y-1/2" />
        </div>

        {/* Right Section with Content */}
        <div className="lef lg:w-[59%] w-full py-10">
          <h2 className='font-bold lg:text-4xl text-3xl px-8 leading-relaxed'>
            Your Safety Is Our Priority, We make sure both drivers and riders feel safe.
          </h2>
          <div className="cards grid gap-8 pt-5 px-8 lg:w-[60%]">
            ...
            <div className="card flex items-center gap-5">
              ...
              <div className="left">
                ...
                <p className='text-gray-700 text-sm'>All travelers undergo ID verification for security.</p>
              </div>
            </div>
            
            <div className="card flex items-center gap-5">
              <div className="right">
                <img src={icon8} alt="Live Trip Tracking" />
              </div>
              <div className="left">
